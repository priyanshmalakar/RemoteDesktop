...
//             componentProps: {
//                 data: {
//                     pw: this.settingsService.settings.rememberPassword
//                         ? this.settingsService.settings.rememberedPassword
//                         : '',
//                     newPw: this.settingsService.settings.rememberPassword
//                         ? this.settingsService.settings.rememberedPassword
//                         : '',
//                 },
//             },
...
//             if (this.settingsService.settings.rememberPassword) {
//                 await this.settingsService.saveSettings({
//                     rememberedPassword: data.pw,
//                 });
//             }
//         }
//     }

//     async setPwHash(pw: string) {
//         try {
//             const hash = await this.electronService.bcryptjs.hash(pw, 5);
//             await this.settingsService.saveSettings({
//                 passwordHash: hash,
...
//     async rememberPwChange() {
//         await this.settingsService.saveSettings({
//             rememberPassword: this.settingsService.settings.rememberPassword,
//             rememberedPassword: this.settingsService.settings.rememberedPassword
//         });
//     }
